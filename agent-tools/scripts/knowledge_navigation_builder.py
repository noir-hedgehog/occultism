...
def build(root: str | Path = ".") -> dict[str, Any]:
    ...
    result = {
        ...
        "primary_navigation": [
            ...
            {"title": "案例采集模板", "path": "知识库/案例采集模板.md"},
            {"title": "交互可用化矩阵", "path": "知识库/交互可用化矩阵.md"},
            {"title": "Web UI Surface Smoke 验证", "path": "知识库/WebUISurfaceSmoke验证.md"},
...
def render_markdown(result: dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            "- [案例采集模板](案例采集模板.md)",
            "- [交互可用化矩阵](交互可用化矩阵.md)",
            "- [Web UI Surface Smoke 验证](WebUISurfaceSmoke验证.md)",
