...
| --- | --- | --- |
| `tool_manifest` | True | 279 tools, 61 skills |
| `tool_wrapper_manifest` | True | 279/279 wrappers ready |
| `tool_definition_export` | True | 279 tool definitions exported |
| `tool_definition_validation` | True | 279/279 definitions valid |
| `tool_registry` | True | 279 tools ready for runtime registration |
| `tool_registry_validation` | True | 279 tools, 0 failed skill checks |
