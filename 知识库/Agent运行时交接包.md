...
| --- | --- | --- |
| `tool_manifest` | True | 283 tools, 61 skills |
| `tool_wrapper_manifest` | True | 283/283 wrappers ready |
| `tool_definition_export` | True | 283 tool definitions exported |
| `tool_definition_validation` | True | 283/283 definitions valid |
| `tool_registry` | True | 283 tools ready for runtime registration |
| `tool_registry_validation` | True | 283 tools, 0 failed skill checks |
