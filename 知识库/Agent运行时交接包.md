...
| --- | --- | --- |
| `tool_manifest` | True | 284 tools, 61 skills |
| `tool_wrapper_manifest` | True | 284/284 wrappers ready |
| `tool_definition_export` | True | 284 tool definitions exported |
| `tool_definition_validation` | True | 284/284 definitions valid |
| `tool_registry` | True | 284 tools ready for runtime registration |
| `tool_registry_validation` | True | 284 tools, 0 failed skill checks |
