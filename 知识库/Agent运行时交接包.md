...
| --- | --- | --- |
| `tool_manifest` | True | 282 tools, 61 skills |
| `tool_wrapper_manifest` | True | 282/282 wrappers ready |
| `tool_definition_export` | True | 282 tool definitions exported |
| `tool_definition_validation` | True | 282/282 definitions valid |
| `tool_registry` | True | 282 tools ready for runtime registration |
| `tool_registry_validation` | True | 282 tools, 0 failed skill checks |
