...
| `context_doc_links_js` | `knowledge_docs_site` | `GET` | `/static/app.js` | True | text_length=29336 | - |
| `tool_chain_grouping_js` | `consultation_packet` | `GET` | `/static/app.js` | True | text_length=29336 | - |
